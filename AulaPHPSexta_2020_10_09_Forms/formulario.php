<html>
    ...
    <body>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Digite sua banda favorita: 
                <input type="text" name="txt_banda" />
                <span class="error">*<?php echo $bandaErr; ?></span>
            </p>
            <p>Informações sobre sua banda favorita:<br>
                <textarea cols="50" rows="10"name="info_banda" /></textarea>
        ...
        <?php
        if (($_SERVER["REQUEST_METHOD"] == "POST") &&
                (!empty($_POST["rdo_genero"]) && !empty($_POST["txt_banda"]) && !empty($_POST["info_banda"]))) {
            ?>
            <p>Os dados enviados foram:</p>
            <?php
            echo "<b>Genero: </b>" . $genero;
            echo "<br>";
            echo "<b>Banda: </b>" . $banda;
            echo "<br>";
            echo "<b>Informações: </b>" . $info;
        }
        ?>
